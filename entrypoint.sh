...
#BIND_DATA_DIR=${DATA_DIR}/bind        # /data/bind
#WEBMIN_DATA_DIR=${DATA_DIR}/webmin    # /data/webmin

BIND_DATA_DIR=/etc/bind        # /data/bind
WEBMIN_DATA_DIR=/etc/webmin    # /data/webmin
...
#  fi
#  rm -rf /etc/bind
#  ln -f ${BIND_DATA_DIR}/etc /etc/bind
...
#  fi
#  rm -rf /var/lib/bind
#  ln -f ${BIND_DATA_DIR}/lib /var/lib/bind
}
...
#  fi
#  rm -rf /etc/webmin
#  ln -f ${WEBMIN_DATA_DIR}/etc /etc/webmin
}
